...
const profileImage = require('./controllers/routers/profileImage')
...
const myGradesRouter = require('./controllers/routers/grades/myGrades')
...
app.use('/myGrades' , myGradesRouter)
